...
Please be sure to check the Privacy Policies of these sites as well as their “Terms of Service” before engaging in any business or uploading any information. 
    ...
    <ul style="list-style-type:none; padding: 4% 0% 1% 0%; ">
        ...
        <li> <h3>Consent</h3>
            <ul style="list-style-type:none;">
                <li style="margin: 30px 0;">By using our website, you hereby consent to our disclaimer and agree to its terms. </li>
            </ul>
        </li>
        <li> <h3> Update </h3>
            <ul style="list-style-type:none;">
                <li style="margin: 30px 0;"><p>Should we update, amend or make any changes to this document, those changes will be prominently posted here. Last update was made February 18, 2020.</p></li>
            </ul>
        </li>
    </ul>
</div>
