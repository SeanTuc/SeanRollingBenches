...
<div class="card-deck" style="padding-left: 10%; padding-right: 10%; padding-bottom: 3%">
  ...
  <div class="card bg-dark"  >
      <div class="card-body text-center " style="color: white; position: relative;" >  
        <p class="card-text" style="padding-bottom: 10%;"> <h2 class="main-content-title" style="color: white; min-height: 5em; padding-bottom: 10%; ">MAX ROLL EBB & FLOW BENCHES:</h2>
        <a href="images/max_roll_ebb_flow.png">
          <img class="card-img-top; img-fluid" src="images/max_roll_ebb_flow.png" alt="Max Roll Ebb and Flow bench" style="width:100%; height: auto; max-height: 260px; padding-bottom: 10%">
          </a>
...
<div class="card-deck" style="padding-left: 10%; padding-right: 10%; padding-bottom: 3%">
    ...
    <div class="card bg-dark" >
        <div class="card-body text-center " style="color: white; position: relative;">
            ...
            <p class="card-text" style="padding-bottom: 10%"> <h2 class="main-content-title" style="color: white; min-height: 6em; padding-bottom: 10%" >MAX ROLL EXPANDED METAL BENCHES:</h2>
            <a href="images/max_roll_stationary_expanded_metal_benches.png">
            <img class="card-img-top; img-fluid" src="images/max_roll_stationary_expanded_metal_benches.png" alt="Max Roll and Stationary Expanded Metal Benches" 
...
<div class="card bg-dark" >
        <div class="card-body text-center " style="color: white; position: relative; ">    
          ...
          <a href="images\stationary_vertical_growing.png">
            <img class="card-img-top; img-fluid" src="images\stationary_vertical_growing.png" alt="Stationary Vertical Growing Benches" style="width:100%; height: auto; max-height: 260px; padding-bottom: 10%">
          </a>
            <div style="text-align: left"></p>
          <p style="text-indent: 1em; padding-bottom: 20pt;">
          ...
          this is one of the best ways to maximize your space and your yields. </p> 
            ...
            <div style="width:90%; bottom:0; position: absolute; padding-bottom: 10pt; margin:auto;">
              <a href="stationary_vertical_growing.php" class="btn btn-secondary" style=" bottom:0; ">More Details</a>
            </div>
        </div>
      </div>
