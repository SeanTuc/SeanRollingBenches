  ...
  <div class="card bg-dark"  >
      <div class="card-body text-center " style="color: white" >  
        ...
        <a href="images/Ebb_Flow_bench_1.jpg">
          <img class="card-img-top; img-fluid" src="images/Ebb_Flow_bench_1.jpg" alt="Max Roll Ebb and Flow bench" style="width:100%; height: auto; max-height: 260px; padding-bottom: 10%">
          </a>
